...
interface TubeTypeReferenceProps {
  ...
  return (
    <div className="rounded-3xl bg-white p-6 shadow-md">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {tubeTypes.map((tube) => (
          <div key={tube.name} className="rounded-xl bg-slate-50 p-4">
            <div className="flex items-center gap-3">
              <span
                className={`h-4 w-4 shrink-0 rounded-full ${tube.colorClass}`}
              />
